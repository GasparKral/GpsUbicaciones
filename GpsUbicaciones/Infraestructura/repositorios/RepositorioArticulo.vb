Public Class RepositorioArticulo
    ...
    Public Shared Function ObtenerInformacion(CodigoArticulo As String) As Articulo
        Try
            Dim dsArticulo = ObtenerFila(Operacion.ExecuteQuery(Querys.Select.ConsultarDatosBasicosArticuloPorCodigo, CodigoArticulo, CodigoArticulo, CodigoArticulo, Almacen), 0, 0)
