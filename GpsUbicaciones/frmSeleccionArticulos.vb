...
Public Class frmSeleccionArticulos
    ...
    Private Sub frmSeleccionArticulos_Load() Handles MyBase.Load
        ...
        If GridViewArticulosSeleccionados IsNot Nothing Then
            ...
            colArticulo.FieldName = "Articulo"  ' Cambiar de "CodigoUbicacion" a "Articulo"
            ...
            colNombre.FieldName = "Nombre"  ' Cambiar de "NombreComercial" a "Nombre"
            ...
            colUbicacion.FieldName = "Ubicacion"  ' Cambiar de "Destino" a "Ubicacion"
